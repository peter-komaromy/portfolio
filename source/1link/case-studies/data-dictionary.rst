...
.. grid:: 1 1 2 2
  ...
  .. grid-item-card::
    ...
    The sample below includes selected columns from four data marts. It shows search, filters, expandable rows, dropdown options, copy actions, popovers for truncated values, and detail panels for technical context.
